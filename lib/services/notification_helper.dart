...
class NotificationHelper {
  ...
  Future selectNotification(String? payload) async {
    ...
    Get.to(() => DisplayTask(id:int.parse(payload.toString()),));
  }

  Future onDidReceiveLocalNotification(int? id, String? title, String? content, String? payload) async {
  ...
  timeZone.TZDateTime _convertTime(int hour,int minute){
    ...
    timeZone.TZDateTime scheduledDate = timeZone.TZDateTime(timeZone.local,now.year,now.month,now.day,hour,minute);
